...
namespace ClienteService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260916220000_ReservarRangoIdentidadSeedProyecciones")]
    partial class ReservarRangoIdentidadSeedProyecciones
    {
            ...
            modelBuilder.Entity("ClienteService.Domain.Entities.Cliente", b =>
                {
                    b.HasOne("ClienteService.Domain.Entities.Persona", null)
                        .WithOne()
                        .HasForeignKey("ClienteService.Domain.Entities.Cliente", "PersonaId")
